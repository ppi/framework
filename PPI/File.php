...
class File {
	 ...
	 * @return string
	 */
	function getFileExtension($fileName, $includeDot = false) {
	 ...
	 *
	 * @param string $templateFile Filename
	 * @param string $ext Extension
	 * @return string
	 */
	static function checkExtension($templateFile, $ext) {

		if(strripos($templateFile, $ext) === false) {
			$templateFile .= $ext;
		}
		return $templateFile;
	}
	...
	/**
	 * Get the type of file from the filename.
	 * 
	 * @static
