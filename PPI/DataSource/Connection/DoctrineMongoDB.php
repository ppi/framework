...
use Doctrine\MongoDB\Connection as DoctrineMongoDBConnection;

class DoctrineMongoDB implements ConnectionInferface
{
    ...
    public function getConnectionByName($name)
    {
        ...
        if (!isset($this->config[$name])) {
            throw new \Exception('No doctrine mongodb connection found named: ' . $name);
        }
        ...
        if (!isset($this->conns[$name])) {
            $this->conns[$name] = new DoctrineMongoDBConnection(
    ...
    {
        return $library === 'doctrine_mongob';
    }
