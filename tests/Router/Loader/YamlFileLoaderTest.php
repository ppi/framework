...
namespace PPI\FrameworkTest\Router\Loader;
...
class YamlFileLoaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return array(array('nonvalid.yml'), array('nonvalid2.yml'), array('incomplete.yml'), array('nonvalidkeys.yml'),
            array('nonesense_resource_plus_path.yml'), array('nonesense_type_without_resource.yml'), );
    }
