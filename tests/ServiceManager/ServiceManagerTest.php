...
use PPI\FrameworkTest\ServiceManager\Fixtures\FooCounterAbstractFactory;
...
class ServiceManagerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAddAbstractFactory()
    {
        ...
        $ret = $this->serviceManager->addAbstractFactory(new Fixtures\FooAbstractFactory());
        $this->assertSame($this->serviceManager, $ret);
    }
    ...
    {
        $initializer = new Fixtures\FooInitializer();
    ...
    {
        $this->serviceManager->addAbstractFactory('PPI\FrameworkTest\ServiceManager\Fixtures\FooAbstractFactory');
        $this->serviceManager->setAlias('foo', 'PPI\FrameworkTest\ServiceManager\Fixtures\FooAbstractFactory');
    ...
    public function testCreateTheSameServiceWithMultipleAbstractFactoriesReversePriority()
    {
        $this->serviceManager->addAbstractFactory('PPI\FrameworkTest\ServiceManager\Fixtures\FooAbstractFactory');
        $this->serviceManager->addAbstractFactory('PPI\FrameworkTest\ServiceManager\Fixtures\FooFakeAbstractFactory');
        $this->assertInstanceOf('PPI\FrameworkTest\ServiceManager\Fixtures\FooFake', $this->serviceManager->get('foo'));
    }

    public function testCreateWithInitializerObject()
    {
        $this->serviceManager->addInitializer(new Fixtures\FooInitializer(array('foo' => 'bar')));
        $this->serviceManager->setFactory('foo', function () {
            return new \stdClass();
        });
        $obj = $this->serviceManager->get('foo');
    ...
    public function testConfigureWithInvokableClass()
    {
        $config = new Config(array(
            'invokables' => array(
                'foo' => 'PPI\FrameworkTest\ServiceManager\Fixtures\Foo',
            ),
        ));
        $serviceManager = new ServiceManager($config);
        $foo            = $serviceManager->get('foo');
        $this->assertInstanceOf('PPI\FrameworkTest\ServiceManager\Fixtures\Foo', $foo);
    }
    ...
    public function testCannotUseUnknownServiceNameForAbstractFactory()
    {
        $config = new Config(array(
            'abstract_factories' => array(
                'PPI\FrameworkTest\ServiceManager\Fixtures\FooAbstractFactory',
            ),
        ));
        $serviceManager = new ServiceManager($config);
        $serviceManager->setFactory('foo', 'PPI\FrameworkTest\ServiceManager\Fixtures\FooFactory');
    ...
    {
        $abstractFactory = new Fixtures\TrollAbstractFactory();
    ...
    {
        $abstractFactory = new Fixtures\WaitingAbstractFactory();
        $this->serviceManager->addAbstractFactory($abstractFactory);
    ...
    {
        $result = $this->serviceManager->addInitializer('PPI\FrameworkTest\ServiceManager\Fixtures\FooInitializer');
    ...
    public function testGetGlobIteratorServiceWorksProperly()
    {
        $config = new Config(array(
            'invokables' => array(
                'foo' => 'PPI\FrameworkTest\ServiceManager\Fixtures\GlobIteratorService',
            ),
        ));
        $serviceManager = new ServiceManager($config);
        $foo            = $serviceManager->get('foo');
        $this->assertInstanceOf('PPI\FrameworkTest\ServiceManager\Fixtures\GlobIteratorService', $foo);
    }
    ...
    public function testWanCreateFromAbstractFactoryWillNotInstantiateAbstractFactoryOnce()
    {
        ...
        $this->serviceManager->addAbstractFactory(__NAMESPACE__ . '\Fixtures\FooCounterAbstractFactory');
